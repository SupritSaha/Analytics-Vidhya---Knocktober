...
# Reading datasets
# =================================================================================
FHCA <- read.csv("Train/First_Health_Camp_Attended.csv",header = TRUE,na.strings = "")
HCD <- read.csv("Train/Health_Camp_Detail.csv",header = TRUE,na.strings = "")
PP <- read.csv("Train/Patient_Profile.csv",header = TRUE,na.strings = "")
SHCA <- read.csv("Train/Second_Health_Camp_Attended.csv",header = TRUE,na.strings = "")
THCA <- read.csv("Train/Third_Health_Camp_Attended.csv",header = TRUE,na.strings = "")
Train <- read.csv("Train/Train.csv",header = TRUE,na.strings = "")

# Reading test data
# =================================================================================
Test <- read.csv("Test 2.csv",header = TRUE,na.strings = "")
